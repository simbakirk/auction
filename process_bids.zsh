...
variable_name="Running process_bids script"
current_datetime=$(date "+%Y%m%d-%H%M%S")
log_level="3"
BASEDIR=/samba/auction

#Capture output to file -n, supress terminal output
exec > $BASEDIR/output_shell/process_bids.log
exec 2> $BASEDIR/output_shell/process_bids_err.log
...
cd $BASEDIR
/usr/bin/python3 $BASEDIR/process_bids.py $log_level 3
